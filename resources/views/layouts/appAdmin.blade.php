                  ...
                  <p class="text-primary text-uppercase">Bienvenido {{ Auth::user()->name }}</p> 
                    ...
                    <div class="collapse navbar-collapse tipob" id="navbarNavDropdown">
                            <ul class="navbar-nav w-100 justify-content-end">
                                ...
                                <li class="nav-item">
                                  <a class="nav-link" href="{{ url('/admin/temas') }}" aria-expanded="false">Temas </a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="{{ url('/admin/articulos') }}" aria-expanded="false">Articulos </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="{{ url('/admin/usuarios') }}" aria-expanded="false">Usuarios </a>
                          </li>
